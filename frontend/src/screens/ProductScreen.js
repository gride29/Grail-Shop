    ...
    <>
      ...
      {loading ? (
        ...
        <>
          ...
          <Row>
            <Col md={6}>
              <h2 style={{ marginTop: "1.5rem" }}>Recenzje</h2>
              ...
              <ListGroup variant="flush">
                {product.reviews.map((review) => (
                  <ListGroup.Item key={review._id}>
                    ...
                    <p className="mt-2 my-1">{review.comment}</p>
                  </ListGroup.Item>
                ))}
                <ListGroup.Item>
                  ...
                  {userInfo ? (
                    <Form onSubmit={submitHandler}>
                      <Form.Group controlId="rating">
                        <Form.Label className="mt-2">Ocena</Form.Label>
                        <select
                          className="form-select"
                          value={rating}
                        ...
                        >
                          ...
                          <option value="2">2 - Zadowalająca</option>
